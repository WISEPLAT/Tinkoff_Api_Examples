"""
    Этот код является примером применения торговой стратегии для нескольких тикеров.
    Стратегия в этом коде предназначена только для демонстрации
    - она выводит значения OHLCV для тикеров.
